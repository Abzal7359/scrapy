...
class BookspiderSpider(scrapy.Spider):
    ...
    # user_agent_list=['Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',]
    ...
    def parse(self, response):
        ...
        # book_title=book.css('h3 a').attrib['title']
        for book in books:
        ...
        #----below code to get book names ,price,url in all pages
        # for book in books:
        #     yield {
        #         'book name':book.css('h3 a').attrib['title'],
        ...
        #-----------below is right code from git hub
        # def parse_book_page(self, response):
        #
        #     table_rows = response.css("table tr")
        #
